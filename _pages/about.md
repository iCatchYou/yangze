...
**项目描述:** 本项目综合研究分析了影响有害微生物传播的多种因素，构建有害微生物通过人员接触传播的数学模型；研究了基于多智能体（Agent）仿真计算方法建立城市典型场景人员活动和接触网络模型；研究了基于多智能体仿真计算实验的有害微生物传播预测方法；研究了基于典型有害微生物传播事件的多源数据预测城市内有害微生物传播速度和传播人数；研究了城市典型场景区域有害微生物传播风险评估模型。最终综合集成公共卫生应急推演分析、系统建模仿真、应急辅助决策、仿真平台工具等多方面技术，研制开发典型有害微生物传播事件预测系统。此系统能够基于有害微生物传播事件的多源数据，仿真推演计算城市内有害微生物传播过程、识别有害微生物传播关键节点、预测有害微生物传播速度和范围、评估风险、分析对比不同防控措施的防控效果。
